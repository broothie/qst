...
func RawURL(url *pkgurl.URL) option.Func[*http.Request] {
...
func URL(url string) option.Func[*http.Request] {
	return func(request *http.Request) (*http.Request, error) {
		...
		return RawURL(u)(request)
	}
}

// Scheme applies the scheme to the *http.Request URL.
func Scheme(scheme string) option.Func[*http.Request] {
	return func(request *http.Request) (*http.Request, error) {
...
func User(user *pkgurl.Userinfo) option.Func[*http.Request] {
	return func(request *http.Request) (*http.Request, error) {
...
func Path(segments ...string) option.Func[*http.Request] {
	return func(request *http.Request) (*http.Request, error) {
...
func Query(key, value string) option.Func[*http.Request] {
	return func(request *http.Request) (*http.Request, error) {
...
func Header(key, value string) option.Func[*http.Request] {
	return func(request *http.Request) (*http.Request, error) {
...
func Authorization(authorization string) option.Func[*http.Request] {
	return Header("Authorization", authorization)
}

// BasicAuth applies a username and password basic auth header.
func BasicAuth(username, password string) option.Func[*http.Request] {
	return func(request *http.Request) (*http.Request, error) {
...
func TokenAuth(token string) option.Func[*http.Request] {
...
func BearerAuth(token string) option.Func[*http.Request] {
	return Authorization(fmt.Sprintf("Bearer %s", token))
}

// Context applies a context.Context to the *http.Request.
func Context(ctx context.Context) option.Func[*http.Request] {
	return func(request *http.Request) (*http.Request, error) {
...
func ContextValue(key, value interface{}) option.Func[*http.Request] {
	return func(request *http.Request) (*http.Request, error) {
		return Context(context.WithValue(request.Context(), key, value))(request)
	}
}

// Body applies an io.ReadCloser to the *http.Request body.
func Body(body io.ReadCloser) option.Func[*http.Request] {
	return func(request *http.Request) (*http.Request, error) {
		request.Body = body
		return request, nil
	}
...
func BodyJSON(v interface{}) option.Func[*http.Request] {
	return func(request *http.Request) (*http.Request, error) {
...
func BodyXML(v interface{}) option.Func[*http.Request] {
	return func(request *http.Request) (*http.Request, error) {
		body := new(bytes.Buffer)
...
func Dump(w io.Writer) option.Func[*http.Request] {
	return func(request *http.Request) (*http.Request, error) {
